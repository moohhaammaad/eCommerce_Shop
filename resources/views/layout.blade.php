...
<!-- header -->
	<div class="agileits_header">
		<div class="container">
			...
			<div class="product_list_header">  
				<a href="/checkout" style="background: unset;" class="w3view-cart" type="submit" name="submit" value=""><i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
			</div>
	...
	<div class="logo_products">
		...
		<div class="w3l_search">
			<form action="/search">
				<input name="q" type="search" name="Search" placeholder="Search for a Product..." required="">
...
<div class="footer">
		<div class="container">
			<div class="w3_footer_grids">
				...
				<div class="col-md-3 w3_footer_grid">
					...
					<ul class="info">
						@foreach(categories() as $category)
						<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="/category/{{$category->id}}">{{$category->name}}</a></li>
						@endforeach
					</ul>
				</div>
				<div class="col-md-3 w3_footer_grid">
		...
		<div class="footer-copy">
			...
			<div class="container">
				<p>© 2020 CLS Team. All rights reserved </p>
			</div>
		</div>
